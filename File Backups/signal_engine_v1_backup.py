    ...
    def _load_strategy_performance(self) -> None:
        ...
        try:
            ...
            self.strategy_performance = {
                ...
                'volume_profile': {'win_rate': 0.60, 'profit_factor': 1.5, 'weight': 0.9},
                'market_profile': {'win_rate': 0.62, 'profit_factor': 1.6, 'weight': 1.0},
                'order_flow': {'win_rate': 0.64, 'profit_factor': 1.7, 'weight': 1.05},
                'wyckoff': {'win_rate': 0.70, 'profit_factor': 2.0, 'weight': 1.15},
                'gann': {'win_rate': 0.63, 'profit_factor': 1.6, 'weight': 1.0},
                'fibonacci_advanced': {'win_rate': 0.66, 'profit_factor': 1.8, 'weight': 1.1},
                'momentum_divergence': {'win_rate': 0.65, 'profit_factor': 1.7, 'weight': 1.05},
                
                # SMC Strategies
                'market_structure': {'win_rate': 0.71, 'profit_factor': 2.0, 'weight': 1.2},
                'liquidity_pools': {'win_rate': 0.69, 'profit_factor': 1.9, 'weight': 1.15},
                'manipulation': {'win_rate': 0.68, 'profit_factor': 1.85, 'weight': 1.1},
